...
const aircraftOptions = [
  {
    ...
    desc: 'Midsize jets can handle the Moscow to Bodrum route but may operate near their range limits. Suitable for smaller groups.',
  },
  {
    category: 'Super-Midsize Jets',
    suitability: 'Ideal',
    desc: 'Super-midsize jets offer the optimal balance of range, speed, and cabin comfort for this popular route from Russia.',
  },
  {
    category: 'Heavy Jets',
    suitability: 'Maximum Comfort',
    desc: 'Heavy jets provide spacious stand-up cabins with sleeping arrangements and full amenities for families and VIP travelers.',
  },
];
...
export default function MoscowToBodrum() {
  useEffect(() => {
    ...
    --------------------------------*/
    const ogTags = [
      ['meta[property="og:title"]', 'Private Jet Moscow → Bodrum'],
      [
    ...
    --------------------------------*/
    const twitterTags = [
      ['meta[name="twitter:title"]', 'Private Jet Moscow → Bodrum'],
      [
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-navy">
        <div className="max-w-6xl mx-auto px-5 text-center">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-semibold leading-tight mb-6">
            Moscow to Bodrum <span className="text-gold">Private Jet Route</span>
          </h1>
          <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            A complete guide to flying privately from Moscow to Bodrum.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-center text-navy/70 text-lg leading-relaxed mt-8">
              The flight from Moscow to Bodrum covers approximately 2,400 kilometers across Eastern Europe and the Black Sea region. A well-established route connecting Russia with Turkey's premier Aegean destination.
            </p>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: 'The preferred airport for private jet departures from Moscow, with modern executive terminals and fast handling.',
              },
              {
                name: 'Moscow Sheremetyevo (SVO)',
                desc: "Russia's largest international airport also accommodates business aviation with dedicated VIP facilities.",
              },
            ].map((a, i) => (
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white p-10 shadow-sm border-t-4 border-gold text-center">
              ...
              <p className="text-navy/70 text-lg leading-relaxed mt-4">
                All private jet arrivals from Moscow land at Milas-Bodrum Airport. Private Jet Bodrum coordinates GAT access, apron-side transfers, and direct onward transportation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-navy">
        <div className="max-w-4xl mx-auto px-5 text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white mb-6">
            Fly from Moscow to <span className="text-gold">Bodrum</span>
          </h2>

          <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto leading-relaxed mb-10">
            Share your travel dates and passenger count. Our concierge team will prepare tailored aircraft options for your Moscow to Bodrum journey.
          </p>

          <a
            href="/#contact"
            aria-label="Request Your Moscow to Bodrum Quote"
          ...
          >
            Request Your Moscow → Bodrum Quote
          </a>
