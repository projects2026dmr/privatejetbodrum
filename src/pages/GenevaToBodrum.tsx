...
const aircraftOptions = [
  {
    ...
    desc: 'Light jets handle the Geneva to Bodrum route comfortably, offering efficiency for couples or small groups.',
  },
  {
    category: 'Midsize Jets',
    suitability: 'Ideal',
    desc: 'Midsize jets are the most popular choice, providing generous cabin space and smooth performance for this route.',
  },
  {
    category: 'Super-Midsize Jets',
    suitability: 'Maximum Comfort',
    desc: 'Super-midsize jets deliver a premium experience with stand-up cabins, enhanced amenities, and faster cruising speeds.',
  },
];
...
export default function GenevaToBodrum() {
  useEffect(() => {
    ...
    metaDescription.setAttribute(
      'content',
      'Flight time, aircraft options, and route details for private jet flights from Geneva to Bodrum.'
    );
    ...
    canonical.setAttribute(
      'href',
      'https://privatejetbodrum.vercel.app/geneva-to-bodrum'
    );
    ...
    --------------------------------*/
    const ogTags = [
      ['meta[property="og:title"]', 'Private Jet Geneva → Bodrum'],
      [
      ...
      [
        ...
        'https://privatejetbodrum.vercel.app/images/og/geneva-bodrum.jpg',
      ],
    ];
    ...
    --------------------------------*/
    const twitterTags = [
      ['meta[name="twitter:title"]', 'Private Jet Geneva → Bodrum'],
      [
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-navy">
        <div className="max-w-6xl mx-auto px-5 text-center">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-semibold leading-tight mb-6">
            Geneva to Bodrum <span className="text-gold">Private Jet Route</span>
          </h1>
          <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            A complete guide to flying privately from Geneva to Bodrum.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-center text-navy/70 text-lg leading-relaxed mt-8">
              The flight from Geneva to Bodrum covers approximately 2,200 kilometers across Europe. A direct and convenient route connecting Switzerland's lakeside city with Turkey's Aegean paradise.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-sand p-8 text-center">
              ...
              <p className="text-navy/70 text-sm leading-relaxed">
                Geneva Airport features a dedicated business aviation center with premium VIP terminals, offering seamless and discreet private jet departures.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white p-10 shadow-sm border-t-4 border-gold text-center">
              ...
              <p className="text-navy/70 text-lg leading-relaxed mt-4">
                All private jet arrivals from Geneva land at Milas-Bodrum Airport. Private Jet Bodrum coordinates GAT access, apron-side transfers, and direct onward transportation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-navy">
        <div className="max-w-4xl mx-auto px-5 text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white mb-6">
            Fly from Geneva to <span className="text-gold">Bodrum</span>
          </h2>

          <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto leading-relaxed mb-10">
            Share your travel dates and passenger count. Our concierge team will prepare tailored aircraft options for your Geneva to Bodrum journey.
          </p>

          <a
            href="/#contact"
            aria-label="Request Your Geneva to Bodrum Quote"
          ...
          >
            Request Your Geneva → Bodrum Quote
          </a>
