...
const aircraftOptions = [
  {
    ...
    suitability: 'Ideal',
    desc: 'Midsize jets handle the Madrid to Bodrum route comfortably with ample range and cabin space for up to 8 passengers.',
  },
  {
    category: 'Super-Midsize Jets',
    suitability: 'Maximum Comfort',
    desc: 'Super-midsize jets offer a more spacious cabin, higher cruising speed, and enhanced amenities for this medium-range route.',
  },
  {
    category: 'Heavy Jets',
    suitability: 'Premium',
    desc: 'Heavy jets provide stand-up cabins with sleeping arrangements, ideal for larger groups or travelers who demand the highest comfort.',
  },
];
...
export default function MadridToBodrum() {
  useEffect(() => {
    ...
    --------------------------------*/
    const ogTags = [
      ['meta[property="og:title"]', 'Private Jet Madrid → Bodrum'],
      [
    ...
    --------------------------------*/
    const twitterTags = [
      ['meta[name="twitter:title"]', 'Private Jet Madrid → Bodrum'],
      [
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-navy">
        <div className="max-w-6xl mx-auto px-5 text-center">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-semibold leading-tight mb-6">
            Madrid to Bodrum <span className="text-gold">Private Jet Route</span>
          </h1>
          <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            A complete guide to flying privately from Madrid to Bodrum.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-center text-navy/70 text-lg leading-relaxed mt-8">
              The flight from Madrid to Bodrum covers approximately 2,800 kilometers across the Mediterranean. This route connects Spain with Turkey's premier Aegean destination in under four hours.
            </p>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: "Spain's largest airport with dedicated executive terminals for private jet departures.",
              },
              {
                name: 'Madrid Torrejón (TOJ)',
                desc: 'A military and executive airport near Madrid offering efficient private aviation handling.',
              },
            ].map((a, i) => (
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white p-10 shadow-sm border-t-4 border-gold text-center">
              ...
              <p className="text-navy/70 text-lg leading-relaxed mt-4">
                All private jet arrivals from Madrid land at Milas-Bodrum Airport. Private Jet Bodrum coordinates GAT access, apron-side transfers, and direct onward transportation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-navy">
        <div className="max-w-4xl mx-auto px-5 text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white mb-6">
            Fly from Madrid to <span className="text-gold">Bodrum</span>
          </h2>

          <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto leading-relaxed mb-10">
            Share your travel dates and passenger count. Our concierge team will prepare tailored aircraft options for your Madrid to Bodrum journey.
          </p>

          <a
            href="/#contact"
            aria-label="Request Your Madrid to Bodrum Quote"
          ...
          >
            Request Your Madrid → Bodrum Quote
          </a>
