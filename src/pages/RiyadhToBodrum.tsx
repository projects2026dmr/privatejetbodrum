...
const aircraftOptions = [
  {
    ...
    suitability: 'Ideal',
    desc: 'Super-midsize jets provide the optimal balance of range and cabin comfort for the Riyadh to Bodrum route.',
  },
  {
    category: 'Heavy Jets',
    suitability: 'Maximum Comfort',
    desc: 'Heavy jets offer full stand-up cabins, sleeping arrangements, and ample luggage space for families and VIP groups.',
  },
  {
    category: 'Long-Range Jets',
    suitability: 'Optional',
    desc: 'Long-range jets are available for those continuing beyond Bodrum or requiring the highest cabin standards.',
  },
];
...
export default function RiyadhToBodrum() {
  useEffect(() => {
    ...
    --------------------------------*/
    const ogTags = [
      ['meta[property="og:title"]', 'Private Jet Riyadh → Bodrum'],
      [
    ...
    --------------------------------*/
    const twitterTags = [
      ['meta[name="twitter:title"]', 'Private Jet Riyadh → Bodrum'],
      [
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-navy">
        <div className="max-w-6xl mx-auto px-5 text-center">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-semibold leading-tight mb-6">
            Riyadh to Bodrum <span className="text-gold">Private Jet Route</span>
          </h1>
          <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            A complete guide to flying privately from Riyadh to Bodrum.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-center text-navy/70 text-lg leading-relaxed mt-8">
              The flight from Riyadh to Bodrum covers approximately 2,300 kilometers. One of the most popular Gulf-to-Aegean routes, especially during summer months when Saudi travelers seek Mediterranean coastlines.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-sand p-8 text-center">
              ...
              <p className="text-navy/70 text-sm leading-relaxed">
                Riyadh's main international airport with dedicated private aviation terminals and VIP handling services for seamless departures.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white p-10 shadow-sm border-t-4 border-gold text-center">
              ...
              <p className="text-navy/70 text-lg leading-relaxed mt-4">
                All private jet arrivals from Riyadh land at Milas-Bodrum Airport. Private Jet Bodrum coordinates GAT access, apron-side transfers, and direct onward transportation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-navy">
        <div className="max-w-4xl mx-auto px-5 text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white mb-6">
            Fly from Riyadh to <span className="text-gold">Bodrum</span>
          </h2>

          <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto leading-relaxed mb-10">
            Share your travel dates and passenger count. Our concierge team will prepare tailored aircraft options for your Riyadh to Bodrum journey.
          </p>

          <a
            href="/#contact"
            aria-label="Request Your Riyadh to Bodrum Quote"
          ...
          >
            Request Your Riyadh → Bodrum Quote
          </a>
