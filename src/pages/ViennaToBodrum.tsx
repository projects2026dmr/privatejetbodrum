...
const aircraftOptions = [
  {
    ...
    desc: 'Light jets can complete the Vienna to Bodrum route non-stop, making them a practical option for couples or small groups.',
  },
  {
    category: 'Midsize Jets',
    suitability: 'Ideal',
    desc: 'Midsize jets offer the best balance of range, cabin space, and comfort for this Central European route to the Aegean.',
  },
  {
    category: 'Super-Midsize Jets',
    suitability: 'Maximum Comfort',
    desc: 'Super-midsize jets provide premium cabin amenities, faster cruising speeds, and a more spacious travel experience.',
  },
];
...
export default function ViennaToBodrum() {
  useEffect(() => {
    ...
    --------------------------------*/
    const ogTags = [
      ['meta[property="og:title"]', 'Private Jet Vienna → Bodrum'],
      [
    ...
    --------------------------------*/
    const twitterTags = [
      ['meta[name="twitter:title"]', 'Private Jet Vienna → Bodrum'],
      [
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-navy">
        <div className="max-w-6xl mx-auto px-5 text-center">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-semibold leading-tight mb-6">
            Vienna to Bodrum <span className="text-gold">Private Jet Route</span>
          </h1>
          <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            A complete guide to flying privately from Vienna to Bodrum.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-center text-navy/70 text-lg leading-relaxed mt-8">
              The flight from Vienna to Bodrum covers approximately 1,700 kilometers across Southeast Europe. One of the most efficient routes from Central Europe to Turkey's Aegean coastline.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-sand p-8 text-center">
              ...
              <p className="text-navy/70 text-sm leading-relaxed">
                Vienna International Airport offers dedicated business aviation facilities with VIP terminals, private lounges, and fast-track departure procedures.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white p-10 shadow-sm border-t-4 border-gold text-center">
              ...
              <p className="text-navy/70 text-lg leading-relaxed mt-4">
                All private jet arrivals from Vienna land at Milas-Bodrum Airport. Private Jet Bodrum coordinates GAT access, apron-side transfers, and direct onward transportation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-navy">
        <div className="max-w-4xl mx-auto px-5 text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white mb-6">
            Fly from Vienna to <span className="text-gold">Bodrum</span>
          </h2>

          <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto leading-relaxed mb-10">
            Share your travel dates and passenger count. Our concierge team will prepare tailored aircraft options for your Vienna to Bodrum journey.
          </p>

          <a
            href="/#contact"
            aria-label="Request Your Vienna to Bodrum Quote"
          ...
          >
            Request Your Vienna → Bodrum Quote
          </a>
