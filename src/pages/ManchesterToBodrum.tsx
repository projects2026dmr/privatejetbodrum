...
const aircraftOptions = [
  {
    ...
    desc: 'Midsize jets can handle this route with good cabin comfort.',
  },
  {
    category: 'Super-Midsize Jets',
    suitability: 'Ideal',
    desc: 'Super-midsize jets offer the best balance of range and comfort.',
  },
  {
    category: 'Heavy Jets',
    suitability: 'Maximum Comfort',
    desc: 'Heavy jets provide full stand-up cabins and premium amenities.',
  },
];

export default function ManchesterToBodrum() {
  useEffect(() => {
    document.title =
      'Manchester to Bodrum Private Jet Route | Private Jet Bodrum';
    ...
    metaDescription.setAttribute(
      'content',
      'Flight time, aircraft options, and route details for private jet flights from Manchester to Bodrum.'
    );
    ...
    canonical.setAttribute(
      'href',
      'https://privatejetbodrum.vercel.app/manchester-to-bodrum'
    );

    const ogTags = [
      ['meta[property="og:title"]', 'Private Jet Manchester → Bodrum'],
      [
      ...
      [
        ...
        'https://privatejetbodrum.vercel.app/images/og/manchester-bodrum.jpg',
      ],
    ];
    ...
    const twitterTags = [
      ['meta[name="twitter:title"]', 'Private Jet Manchester → Bodrum'],
      [
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-navy">
        <div className="max-w-6xl mx-auto px-5 text-center">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-semibold leading-tight mb-6">
            Manchester to Bodrum{' '}
            <span className="text-gold">Private Jet Route</span>
          </h1>
          <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            A complete guide to flying privately from Manchester to Bodrum.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-center text-navy/70 text-lg leading-relaxed mt-8">
              The flight from Manchester to Bodrum covers approximately 2,800
            ...
            {[
              {
                ...
                desc: 'The main airport for Northern England with private jet handling facilities.',
              },
              {
                name: 'Liverpool John Lennon (LPL)',
                desc: 'An alternative departure point with efficient business aviation services.',
              },
            ].map((a, i) => (
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white p-10 shadow-sm border-t-4 border-gold text-center">
              ...
              <p className="text-navy/70 text-lg leading-relaxed mt-4">
                All private jet arrivals from Manchester land at Milas-Bodrum
      ...
      <section className="py-20 md:py-28 bg-navy">
        <div className="max-w-4xl mx-auto px-5 text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white mb-6">
            Fly from Manchester to <span className="text-gold">Bodrum</span>
          </h2>
          ...
          <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto leading-relaxed mb-10">
            ...
            prepare tailored aircraft options for your Manchester to Bodrum
            journey.
          </p>

          <a
            href="/#contact"
            aria-label="Request Your Manchester to Bodrum Quote"
          ...
          >
            Request Your Manchester → Bodrum Quote
          </a>
