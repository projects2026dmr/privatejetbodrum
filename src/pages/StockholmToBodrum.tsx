...
export default function StockholmToBodrum() {
  useEffect(() => {
    document.title =
      'Stockholm to Bodrum Private Jet Route | Private Jet Bodrum';
    ...
    md.setAttribute(
      'content',
      'Flight time, aircraft options, and route details for private jet flights from Stockholm to Bodrum.'
    );
    ...
    c.setAttribute(
      'href',
      'https://privatejetbodrum.vercel.app/stockholm-to-bodrum'
    );

    const og = [
      ['meta[property="og:title"]', 'Private Jet Stockholm → Bodrum'],
      [
      ...
      [
        ...
        'https://privatejetbodrum.vercel.app/images/og/stockholm-bodrum.jpg',
      ],
    ];
    ...
    const tw = [
      ['meta[name="twitter:title"]', 'Private Jet Stockholm → Bodrum'],
      [
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-navy">
        <div className="max-w-6xl mx-auto px-5 text-center">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-semibold leading-tight mb-6">
            Stockholm to Bodrum <span className="text-gold">Private Jet Route</span>
          </h1>
          <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            A complete guide to flying privately from Stockholm to Bodrum.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-center text-navy/70 text-lg leading-relaxed mt-8">
              The flight from Stockholm to Bodrum covers approximately 2,600
            ...
            {[
              {
                ...
                desc: "Sweden's largest airport with dedicated business aviation terminals.",
              },
              {
                name: 'Stockholm Bromma (BMA)',
                desc: 'A city airport popular for private jet departures.',
              },
            ].map((a, i) => (
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white p-10 shadow-sm border-t-4 border-gold text-center">
              ...
              <p className="text-navy/70 text-lg leading-relaxed mt-4">
                All private jet arrivals from Stockholm land at Milas-Bodrum Airport.
      ...
      <section className="py-20 md:py-28 bg-navy">
        <div className="max-w-4xl mx-auto px-5 text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white mb-6">
            Fly from Stockholm to <span className="text-gold">Bodrum</span>
          </h2>
          ...
          <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto leading-relaxed mb-10">
            ...
            prepare tailored aircraft options for your Stockholm to Bodrum journey.
          </p>

          <a
            href="/#contact"
            aria-label="Request Your Stockholm to Bodrum Quote"
          ...
          >
            Request Your Stockholm → Bodrum Quote
          </a>
