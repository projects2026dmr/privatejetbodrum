...
export default function NurembergToBodrum() {
  useEffect(() => {
    document.title =
      'Nuremberg to Bodrum Private Jet Route | Private Jet Bodrum';
    ...
    metaDescription.setAttribute(
      'content',
      'Flight time, aircraft options, and route details for private jet flights from Nuremberg to Bodrum.'
    );
    ...
    canonical.setAttribute(
      'href',
      'https://privatejetbodrum.vercel.app/nuremberg-to-bodrum'
    );

    const ogTags = [
      ['meta[property="og:title"]', 'Private Jet Nuremberg → Bodrum'],
      [
      ...
      [
        ...
        'https://privatejetbodrum.vercel.app/images/og/nuremberg-bodrum.jpg',
      ],
    ];
    ...
    const twitterTags = [
      ['meta[name="twitter:title"]', 'Private Jet Nuremberg → Bodrum'],
      [
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-navy">
        <div className="max-w-6xl mx-auto px-5 text-center">
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            A complete guide to flying privately from Nuremberg to Bodrum.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-center text-navy/70 text-lg leading-relaxed mt-8">
              The flight from Nuremberg to Bodrum covers approximately 1,800
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-sand p-8 text-center">
              ...
              <p className="text-navy/70 text-sm leading-relaxed">
                Nuremberg's airport with dedicated private aviation handling and
                VIP services.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white p-10 shadow-sm border-t-4 border-gold text-center">
              ...
              <p className="text-navy/70 text-lg leading-relaxed mt-4">
                All private jet arrivals from Nuremberg land at Milas-Bodrum
      ...
      <section className="py-20 md:py-28 bg-navy">
        <div className="max-w-4xl mx-auto px-5 text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white mb-6">
            Fly from Nuremberg to <span className="text-gold">Bodrum</span>
          </h2>
          ...
          <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto leading-relaxed mb-10">
            ...
            prepare tailored aircraft options for your Nuremberg to Bodrum
            journey.
          </p>

          <a
            href="/#contact"
            aria-label="Request Your Nuremberg to Bodrum Quote"
          ...
          >
            Request Your Nuremberg → Bodrum Quote
          </a>
