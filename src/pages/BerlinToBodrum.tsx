...
const aircraftOptions = [
  {
    ...
    desc: 'Light jets can complete the Berlin to Bodrum route efficiently, making them a practical choice for couples or small groups traveling with light luggage.',
  },
  {
    category: 'Midsize Jets',
    suitability: 'Ideal',
    desc: 'Midsize jets offer the best balance of range, cabin comfort, and luggage capacity for this route. They are the most commonly recommended option.',
  },
  {
    category: 'Super-Midsize Jets',
    suitability: 'Maximum Comfort',
    desc: 'Super-midsize jets provide extra cabin space, higher cruising speeds, and a more relaxed in-flight experience for travelers who prioritize comfort.',
  },
];
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-navy">
        <div className="max-w-6xl mx-auto px-5 text-center">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-semibold leading-tight mb-6">
            Berlin to Bodrum <span className="text-gold">Private Jet Route</span>
          </h1>
          <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            A complete guide to flying privately from Berlin to Bodrum.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-center text-navy/70 text-lg leading-relaxed mt-8">
              The Berlin to Bodrum route offers a fast and efficient connection from Germany to the Turkish Riviera. Flight duration may vary slightly depending on aircraft type, weather conditions, and air traffic routing.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 bg-sand">
        <div className="max-w-6xl mx-auto px-5">
          ...
          <p className="text-center text-navy/70 text-lg max-w-2xl mx-auto leading-relaxed mt-10">
            Berlin to Bodrum is well suited to both light and midsize aircraft. Our concierge team will recommend the ideal option based on passenger count, luggage, and comfort preferences.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-center text-navy/70 text-lg leading-relaxed mt-8">
              Private departures from Berlin Brandenburg can be coordinated with VIP handling, flexible departure times, and fast ground procedures for a seamless start to your journey.
            </p>
          </div>
        </div>
      </section>
