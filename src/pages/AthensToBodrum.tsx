...
const aircraftOptions = [
  {
    category: 'Light Jets',
    suitability: 'Ideal',
    desc: 'Light jets are perfect for the short Athens to Bodrum hop, offering a fast and cost-effective option for up to 6 passengers.',
  },
  {
    category: 'Midsize Jets',
    suitability: 'Maximum Comfort',
    desc: 'Midsize jets provide a more spacious cabin for those who want extra room and comfort on this short Aegean crossing.',
  },
];
...
export default function AthensToBodrum() {
  useEffect(() => {
    ...
    --------------------------------*/
    const ogTags = [
      ['meta[property="og:title"]', 'Private Jet Athens → Bodrum'],
      [
    ...
    --------------------------------*/
    const twitterTags = [
      ['meta[name="twitter:title"]', 'Private Jet Athens → Bodrum'],
      [
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-navy">
        <div className="max-w-6xl mx-auto px-5 text-center">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-semibold leading-tight mb-6">
            Athens to Bodrum <span className="text-gold">Private Jet Route</span>
          </h1>
          <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            A complete guide to flying privately from Athens to Bodrum.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-center text-navy/70 text-lg leading-relaxed mt-8">
              The flight from Athens to Bodrum is one of the shortest private jet routes available, covering just 400 kilometers across the Aegean Sea. An effortless hop between two iconic Mediterranean destinations.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-sand p-8 text-center">
              ...
              <p className="text-navy/70 text-sm leading-relaxed">
                Athens International Airport offers dedicated executive aviation facilities with VIP lounges and fast-track handling for private jet departures.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white p-10 shadow-sm border-t-4 border-gold text-center">
              ...
              <p className="text-navy/70 text-lg leading-relaxed mt-4">
                All private jet arrivals from Athens land at Milas-Bodrum Airport. Private Jet Bodrum coordinates GAT access, apron-side transfers, and direct onward transportation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-navy">
        <div className="max-w-4xl mx-auto px-5 text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white mb-6">
            Fly from Athens to <span className="text-gold">Bodrum</span>
          </h2>

          <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto leading-relaxed mb-10">
            Share your travel dates and passenger count. Our concierge team will prepare tailored aircraft options for your Athens to Bodrum journey.
          </p>

          <a
            href="/#contact"
            aria-label="Request Your Athens to Bodrum Quote"
          ...
          >
            Request Your Athens → Bodrum Quote
          </a>
