...
export default function LuganoToBodrum() {
  useEffect(() => {
    document.title =
      'Lugano to Bodrum Private Jet Route | Private Jet Bodrum';
    ...
    md.setAttribute(
      'content',
      'Flight time, aircraft options, and route details for private jet flights from Lugano to Bodrum.'
    );
    ...
    c.setAttribute(
      'href',
      'https://privatejetbodrum.vercel.app/lugano-to-bodrum'
    );

    const og = [
      ['meta[property="og:title"]', 'Private Jet Lugano → Bodrum'],
      [
      ...
      [
        ...
        'https://privatejetbodrum.vercel.app/images/og/lugano-bodrum.jpg',
      ],
    ];
    ...
    const tw = [
      ['meta[name="twitter:title"]', 'Private Jet Lugano → Bodrum'],
      [
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-navy">
        <div className="max-w-6xl mx-auto px-5 text-center">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-semibold leading-tight mb-6">
            Lugano to Bodrum <span className="text-gold">Private Jet Route</span>
          </h1>
          <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            A complete guide to flying privately from Lugano to Bodrum.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-center text-navy/70 text-lg leading-relaxed mt-8">
              The flight from Lugano to Bodrum covers approximately 1,700
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-sand p-8 text-center">
              ...
              <p className="text-navy/70 text-sm leading-relaxed">
                A charming airport in Ticino with private aviation handling services.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white p-10 shadow-sm border-t-4 border-gold text-center">
              ...
              <p className="text-navy/70 text-lg leading-relaxed mt-4">
                All private jet arrivals from Lugano land at Milas-Bodrum Airport.
      ...
      <section className="py-20 md:py-28 bg-navy">
        <div className="max-w-4xl mx-auto px-5 text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white mb-6">
            Fly from Lugano to <span className="text-gold">Bodrum</span>
          </h2>
          ...
          <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto leading-relaxed mb-10">
            ...
            prepare tailored aircraft options for your Lugano to Bodrum journey.
          </p>

          <a
            href="/#contact"
            aria-label="Request Your Lugano to Bodrum Quote"
          ...
          >
            Request Your Lugano → Bodrum Quote
          </a>
